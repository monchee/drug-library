...
| Field | Detail |
|---|---|
| Drug class | Selective relaxant binding agent (SRBA) |
| Stock formulation | 200 mg/2 mL (100 mg/mL) or 500 mg/5 mL (100 mg/mL) |
...
!!! info "Before you start"
    Ensure the vial contains **100 mg/mL**. Check expiry and integrity. Note that sugammadex can encapsulate certain drugs; ensure testing is performed before any clinical administration of steroids or relaxants if possible.

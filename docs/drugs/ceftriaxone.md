...
2. Dissolve completely to obtain **Ceftriaxone 100 mg/mL** (Neat).

### Step 2 — Prepare the SPT solution (100 mg/mL — neat)
1. Draw up **0.5–1 mL** of the neat (100 mg/mL) solution into a 1 mL syringe.
2. Label: **"Ceftriaxone SPT 100 mg/mL"**.

### Step 3 — Prepare IDT dilutions
Prepare in this order, using a fresh syringe for each step.

1. **IDT 10 mg/mL (1:10):** Draw **0.1 mL** of neat (100 mg/mL) into a 1 mL syringe. Add **0.9 mL NS**. Mix. Label: **"Ceftriaxone IDT 10 mg/mL"**.
2. **IDT 1 mg/mL (1:100):** Draw **0.1 mL** of the 10 mg/mL syringe into a new 1 mL syringe. Add **0.9 mL NS**. Mix. Label: **"Ceftriaxone IDT 1 mg/mL"**.

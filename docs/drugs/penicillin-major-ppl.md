---
title: Penicillin Major (PPL)
tags: [penicillin, beta-lactam, determinant, spt, idt]
...
2. The standard RPAH testing concentration is **0.04 mg/20.00 mg per mL** (Neat).

### Step 2 — Prepare the SPT solution (Neat)
1. Draw up **0.1–0.2 mL** of the neat solution.
2. Label: **"PPL SPT (Neat)"**.

### Step 3 — Prepare IDT dilutions
1. **IDT 1:10 (0.004 mg/2 mg per mL):** Draw **0.1 mL** of neat PPL into a 1 mL syringe. Add **0.9 mL** of normal saline. Mix. Label: **"PPL IDT 1:10"**.
